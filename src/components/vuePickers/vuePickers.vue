        ...
        setTop(defaultData) {
            this.$nextTick(() => {
                ...
                if (defaultData.length === 0 && this.isRemember) {
                    if (this.columns === 1) {
                        province.style.transform = province.style[
                            "-webkit-transform"
                        ] = "translate3d(0, 0, 0)";
                        province.setAttribute("top", "0em");
                    } else if (this.columns === 2) {
                        city.setAttribute("top", "0em");
                        city.style["-webkit-transform"] =
                            "translate3d(0, 0, 0)";
                    } else if (this.columns === 3) {
                        county.setAttribute("top", "0em");
                        county.style["-webkit-transform"] =
                            "translate3d(0, 0, 0)";
                    }
                    return;
                }
